...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        file.displayName = "[${project.extra["minecraft_version"] as String}] Human Reborn"
...
modrinth {
    ...
    projectId.set("human-reborn")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Human Reborn")
