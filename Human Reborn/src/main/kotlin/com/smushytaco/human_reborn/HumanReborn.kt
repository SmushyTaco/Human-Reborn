...
object HumanReborn: ModInitializer {
    ...
    private val HUMAN_SPAWN_EGG = SpawnEggItem(HUMAN_ENTITY_TYPE, 5651507, 12422002, Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, SPAWN_EGG_IDENTIFIER)))
